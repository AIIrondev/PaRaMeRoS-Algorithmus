...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _TERMINATIONCRITERIA.fields_by_name['eps_optimal_absolute']._options = None
  _TERMINATIONCRITERIA.fields_by_name['eps_optimal_absolute']._serialized_options = b'\030\001'
  _TERMINATIONCRITERIA.fields_by_name['eps_optimal_relative']._options = None
  _TERMINATIONCRITERIA.fields_by_name['eps_optimal_relative']._serialized_options = b'\030\001'
